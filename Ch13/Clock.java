...
public class Clock extends JPanel implements ActionListener {
    ...
    private double angle1 = -270, angle2 = -270, angle3 = -270;
    private Timer time;
    public Clock() {
        super();
    ...
    public void setTime(int h,int m , int s){
        Hour = h; //  getText from Interface
        Minute = m; //  getText from Interface
        Second = s; //  getText from Interface

        angle1 = angle1 - (6*Second);
        angle2 = angle2 - (6*Minute);
        angle3 = angle3 - (30*Hour);
        repaint();
    }
}
